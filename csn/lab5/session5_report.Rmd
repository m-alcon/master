...
## Algorithm selection
To do so, we selected the algorithm \textfff{label.propagation.community}. We did it because it is nearly a linear-time algorithm, and we need a fast one because of the size of the network.
